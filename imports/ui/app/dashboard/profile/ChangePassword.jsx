...
class ChangePassword extends Component {
  ...
  changePassword() {
    const oldPassword = this.stripTags(this.refs.oldPassword.value.trim());
    const newPassword = this.stripTags(this.refs.newPassword.value.trim());
    const repeatNewPassword = this.stripTags(this.refs.repeatNewPassword.value.trim());
